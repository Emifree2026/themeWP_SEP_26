	...
	function emifree_blog_posts() {
		return array(
			...
			'what-is-air-pressure-loss' => array(
				...
				'excerpt'       => 'A technical guide to air pressure loss in HVAC and industrial ventilation systems — causes, measurement, and how self-cleaning filtration keeps pressure loss consistently low.',
				'category'      => 'Technical Guide',
				'date'          => '2026-08-25',
